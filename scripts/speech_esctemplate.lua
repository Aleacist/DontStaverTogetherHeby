...
return{
	ACTIONFAIL =
	{
        APPRAISE =
        {
            NOTNOW = "Dejame recordar",
        },
        REPAIR =
        {
            WRONGPIECE = "Creo que me falta un tornillo",
        },
        BUILD =
        {
            MOUNTED = "Que palo lo bajo que esta",
            HASPET = "Solamente necesito a uno en mi vida",
        },
		SHAVE =
		{
...
--fallback to speech_wilson.lua 	ANNOUNCE_DISCHARGE = "only_used_by_wx78",
	...
	ANNOUNCE_HUNGRY = "Mi tenno necesita energia",
...
--fallback to speech_wilson.lua     ANNOUNCE_BATTLESONG_INSTANT_PANIC_BUFF = "only_used_by_wathgrithr",
	...
	DESCRIBE =
	{
        ...
        WURT =
        {
            GENERIC = "Deja de inventarte los nombres!",
            ATTACKER = "Solo tarde 4 horas en contestar",
            MURDERER = "Deja de meterte conmigo!",
            REVIVER = "Siempre te tengo que tirar del carrito",
            GHOST = "Eres un inutil",
            FIRESTARTER = "Deja de trollear",
        },
...
--fallback to speech_wilson.lua             BURNING = "I should make something fun.", --for willow to override
        ...
        FISHINGNET = "Fresh seafood awaits!",
        ANTCHOVIES = "Mmmm you'd be delectable in a soup!",
        ...
        ROCK_AVOCADO_BUSH =
        {
            ...
            DISEASING = "I think something's wrong with it.",
        ...
        ICEBERG =
        {
            ...
            MELTED = "Melted like butter!",
        },
        ICEBERG_MELTED = "Melted like butter!",
...
--fallback to speech_wilson.lua         WORTOX_SOUL = "only_used_by_wortox", --only wortox can inspect souls
        ...
        CARNIVAL_BALL = "Perhaps I'll toss it around with the children.",
